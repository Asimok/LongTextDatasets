...
# read_dataset_path_train = '/data2/wangbingchao/dataset/HotpotQA/hotpot_train_v1.1.json'
# output_dataset_path_train = '/data2/maqi/LongTextDatasets/HotpotQA_datasets/simplify_hotpot_train_v1.1.json'
# data = json.load(open(read_dataset_path_train, 'r'))
# out_data = data[0:500]
...
# dev
read_dataset_path_dev = '/data2/wangbingchao/dataset/HotpotQA/hotpot_dev_distractor_v1.json'
output_dataset_path_dev = '/data2/maqi/LongTextDatasets/HotpotQA_datasets/simplify_hotpot_dev_distractor_v1.json'
data = json.load(open(read_dataset_path_dev, 'r'))
out_data = data[0:100]
json.dump(out_data, open(output_dataset_path_dev, 'w'))
print('saved simplify_hotpot_dev_distractor_v1.json')
