...
# devFile = 'hotpot_dev_distractor_v1.json'
...
devFile = 'simplify_hotpot_dev_distractor_v1.json'
testFile = 'simplify_hotpot_dev_distractor_v1.json'
...
current_model = 'test_focal_loss'  # 不同模型的日志保存目录
...
# train
per_gpu_batch_size = 4  # 每个gpu上的batch
num_train_epochs = 15
learning_rate = 1e-4
warmup_steps = 100
